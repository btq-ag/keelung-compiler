...
-- assign' :: UnionFind Bool Bool -> Var -> Bool -> Maybe (Status Bool Bool) -> Maybe (UnionFind Bool Bool)
-- assign' (UnionFind xs) var value varStatus = case varStatus of
--   Nothing -> Just $ UnionFind $ IntMap.insert var (IsConstant value) xs
...
--      in Just $ UnionFind $ rootAssignedValue <> childrenValue
--   Just (IsChildOf root sign) -> assign root (sign == value) (UnionFind xs)

-- -- | Relate two variables.
-- relate :: UnionFind Bool Bool -> Var -> Var -> Bool -> Maybe (UnionFind Bool Bool)
...
-- compose :: UnionFind Bool Bool -> (Var, Maybe (Status Bool Bool)) -> (Var, Maybe (Status Bool Bool)) -> Bool -> Maybe (UnionFind Bool Bool)
