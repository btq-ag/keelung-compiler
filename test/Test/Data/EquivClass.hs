...
module Test.Data.EquivClass (run, tests) where
...
-- applyRelate xs (RelateRefField var1 var2 (slope, intercept)) = case  Relations.runRelM (FieldRef.relate var1 slope var2 intercept xs) of
