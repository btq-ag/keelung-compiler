...
tests = describe "logical" $ do
  ...
  describe "conjunction" $ do
    ...
    it "3 variables" $ do
      ...
      forM_ [gf181, Prime 2, Binary 7] $ \field -> do
        validate field program [0, 0, 0] [] [0]
        validate field program [0, 0, 1] [] [0]
        validate field program [0, 1, 0] [] [0]
        validate field program [0, 1, 1] [] [0]
        validate field program [1, 0, 0] [] [0]
        validate field program [1, 0, 1] [] [0]
        validate field program [1, 1, 0] [] [0]
        validate field program [1, 1, 1] [] [1]
    ...
    it "more than 3 variables + constant" $ do
      ...
      forAll
        ...
        $ \(n, constant, xs) -> do
          ...
          forM_ [gf181, Prime 2, Binary 7] $ \field -> do
            validate field (program constant n) xs [] expected
  ...
  describe "disjunction" $ do
    ...
    it "3 variables" $ do
      ...
      forM_ [gf181, Prime 2, Binary 7] $ \field -> do
        validate field program [0, 0, 0] [] [0]
        validate field program [0, 0, 1] [] [1]
        validate field program [0, 1, 0] [] [1]
        validate field program [0, 1, 1] [] [1]
        validate field program [1, 0, 0] [] [1]
        validate field program [1, 0, 1] [] [1]
        validate field program [1, 1, 0] [] [1]
        validate field program [1, 1, 1] [] [1]
  ...
  describe "exclusive disjunction" $ do
    ...
    it "4 variables" $ do
      ...
      forM_ [gf181, Prime 2, Binary 7] $ \field -> do
        validate field program [0, 0, 0, 0] [] [0]
        validate field program [0, 0, 0, 1] [] [1]
        validate field program [0, 0, 1, 0] [] [1]
        validate field program [0, 0, 1, 1] [] [0]
        validate field program [0, 1, 0, 0] [] [1]
        validate field program [0, 1, 0, 1] [] [0]
        validate field program [0, 1, 1, 0] [] [0]
        validate field program [0, 1, 1, 1] [] [1]
        validate field program [1, 0, 0, 0] [] [1]
        validate field program [1, 0, 0, 1] [] [0]
        validate field program [1, 0, 1, 0] [] [0]
        validate field program [1, 0, 1, 1] [] [1]
        validate field program [1, 1, 0, 0] [] [0]
        validate field program [1, 1, 0, 1] [] [1]
        validate field program [1, 1, 1, 0] [] [1]
        validate field program [1, 1, 1, 1] [] [0]
