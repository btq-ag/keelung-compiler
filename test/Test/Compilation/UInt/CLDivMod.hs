...
tests =
  describe "Carry-less Div/Mod" $ do
    ...
    -- check (Prime 17) program [20, 7] [] [7, 1]
    ...
    it "performCLDivMod (multiple statements)" $ do
      let program = do
            ...
            return [q0, r0, q1, r1]
      check gf181 program [20, 7, 21, 8] [] [7, 1, 2, 5]
    ...
    it "performCLDivMod (multiple statements chained together)" $ do
      let program = do
            ...
            return [q0, r0, q1, r1]
      check (Prime 17) program [25, 3] [] [8, 1, 7, 1]
    ...
    --     check (Prime 17) program [dividend, quotient] [] expected
    --     check gf181 program [dividend, quotient] [] expected
