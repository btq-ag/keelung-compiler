      ...
      let cs =
            ConstraintSystem
              { csConstraints =
                ...
                csBoolVars = mempty,
                csVarCounters = VarCounters 12 0 mempty 0 0 5
              }
              ...
              { csConstraints =
                  Set.fromList $
                    cadd 0 [(0, 1), (1, 1), (4, 1)]
                      ++ cadd 0 [(2, 1), (3, 1), (4, 1)],
                csBoolVars = mempty,
                csVarCounters = VarCounters 4 4 mempty 0 0 1
              }
          cs' =
            ConstraintSystem
              { csConstraints =
                ...
                csBoolVars = mempty,
                csVarCounters = VarCounters 4 4 mempty 0 0 0
              }
      ...
      let cs =
            ConstraintSystem
              { csConstraints =
                ...
                csBoolVars = mempty,
                csVarCounters = VarCounters 3 3 mempty 0 0 1
              }
          cs' =
            ConstraintSystem
              { csConstraints =
                ...
                csBoolVars = mempty,
                csVarCounters = VarCounters 3 3 mempty 0 0 0
              }
       in optimize2 (cs :: ConstraintSystem GF181) `shouldBe` cs'
