...
benchmark =
  ...
  where
    ...
    elaborate' :: Comp GF181 (Val t GF181) -> Either Language.ElabError Elaborated
    elaborate' = elaborate

    compile' :: Comp GF181 (Val t GF181) -> Either (Compiler.Error GF181) (Compiler.ConstraintSystem GF181)
    compile' = optimize